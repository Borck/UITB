  ...
  public class AnchorTransformTest {
    ...
    public IEnumerator SetLocalPosRot_UsingProperties_ExpectCorrectLocalPosRotRelativeToAnchor() {
      ...
      for (var i = 0; i < n; i++) {
        ...
        Asserts.AreApproximatelyEqual( tfExpected.localPosition, goRoot_0_0.transform.localPosition, i );
        Asserts.AreApproximatelyEqual( tfExpected.localRotation, goRoot_0_0.transform.localRotation, i );
      }
    }
    ...
    public IEnumerator SetLocalPosRot_UsingAnimationClip_ExpectCorrectPosRot() {
      ...
      for (var i = 0; i < n; i++) {
        ...
        yield return null; //skip a frame to trigger update values
        Asserts.AreApproximatelyEqual( pose.position, gameObject.transform.localPosition, i );
        Asserts.AreApproximatelyEqual( pose.rotation, gameObject.transform.localRotation, i );
      }
    }
    ...
    private (GameObject goRoot_0, GameObject goRoot_0_0)
      ...
      tfLink.anchor = goRoot.transform;
